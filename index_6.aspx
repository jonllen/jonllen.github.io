...
可能是太久没有跑过了，一跑就如此差劲，不过难受一会儿后昏昏的感觉就没了，那是在汗珠一点一滴掉下来之后
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-11-07 19:48:49</li>
				            <li>阅读(8187)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-11-05 10:35:22</li>
				            <li>阅读(9998)</li>
...
还是用户的增删改查功能的实现为例子，我们先需要定义用户的接口IUser，然后使用不同数据库来分别实现它，程序使用那种数据库则放在properties资源文件里配置，工厂在根据配置产生实例类，以接口形式返回到业务逻辑层，然后在页面里调用业务逻辑层方法。这里我用PowerDesiger简单画了一个类图如下...
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-10-23 09:33:58</li>
				            <li>阅读(13692)</li>
...
整理作者：Jonllen，以上在IE、Firefor3.0、Chrome1.0、Safari4.03、Opera9.64浏览器内测试通
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-10-21 10:46:15</li>
				            <li>阅读(18148)</li>
...
这里我会分为增、删、改、查四个功能来分别在Struts里的实现，然后讲述它每一个功能走的流程。这里先来讲增加功能的实现，在项目里面增加Struts的引用，然后新建useradd.jsp页面，
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-10-19 09:45:27</li>
				            <li>阅读(21354)</li>
...
A2：使用Convert.ToDateTime()进行显示的转换一次即可。说明：Access数据库的时间类型字段需要进行特殊的处理，不然会报错。对于使用OleDbParameter传递参数的时候应该这样来写：parms.Add(new OleDbParameter("postDate", Convert.ToDateTime(article.PostDate.ToString())));先把PostDate的日期类型ToString()再Convert成DateTime类型。 而对于使用sql语句的日期类型...
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-10-11 20:57:25</li>
				            <li>阅读(12628)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-10-09 19:43:04</li>
				            <li>阅读(13121)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-10-01 00:29:37</li>
				            <li>阅读(9363)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-09-24 23:44:34</li>
				            <li>阅读(17201)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-09-20 22:48:43</li>
				            <li>阅读(10543)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-09-14 22:36:58</li>
				            <li>阅读(12100)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-09-11 23:32:22</li>
				            <li>阅读(33064)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-09-07 21:54:26</li>
				            <li>阅读(10905)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-09-05 14:04:02</li>
				            <li>阅读(16864)</li>
...
数字
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-09-01 14:34:03</li>
				            <li>阅读(17924)</li>
...
晚上回来的时候跑到一个买花的店子里，还好有我要的那种仙人掌，小个的仙人球，由于我不要有盆子装好的现成的，店里的伙计帮我重新移植了一侏仙人掌到原来的那个盆子里面去。只有这样充一下数咯，看能
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2008-06-15 15:09:03</li>
				            <li>阅读(9892)</li>
...
IBOX插件是一个独立网站作为IBOX主站的Plugin虚拟目录存在，调用主站Bin内类方法非常不方便，有时候不好和主站交互，如在插件内删除留言的操作我要在IBOX的主站内记录日志，但我又不想把dao、bean重新拷贝一份到插件内来，但发现使用反射可以完美的调用IBOX的主站内任一类库方法，具体实现是通过动态加载IBOX的主站类库程序，动态创建dao、bean类实例，动态调用其方法并可获得返回值，所以IBOX插件网站也能调用IBOX的主站IBOX_DB.dll、IBOX_DL.dll内任一方法，希望下次能用到。
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-08-26 14:45:55</li>
				            <li>阅读(11431)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-08-23 09:16:06</li>
				            <li>阅读(9592)</li>
...
另外，后续挖掘中。。。
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-08-20 14:58:23</li>
				            <li>阅读(8352)</li>
...
广佛都市网模块开发卷宗（GB856788）....................................................
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2009-08-16 22:26:01</li>
				            <li>阅读(13932)</li>
...
<script type='text/javascript'>function goToPage0(pid, urlformat){var url = "index__pid.aspx";if(urlformat)url=urlformat;document.location.replace(url.replace("_pid",pid).replace("_1.","."));}</script>
                            ...
                            <!--每页<input type='text' value='20' id='_pagersize0' style='width:25px'>条,转到第<input type='text' value='6' id='_pagerid0' style='width:25px'>页<input type='button' value='Go' onclick='javascript:goToPage0(document.getElementById("_pagerid0").value,"index__pid.aspx".replace("psize=20","psize=" + document.getElementById("_pagersize0").value));'>-->
