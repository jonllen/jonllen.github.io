...
<head>
<title>天河部落 - 友情链接 - 金龙博客</title>
<meta name="description" content="http://www.thjy.org" />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2015-09-07' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     > <a href="/links/">友情链接</a>
		     > <a href="http://www.thjy.org">天河部落</a>
		</div>
        <div class="article">
			<div class="title"><h2>天河部落</h2></div>
			<div class="category">分类：<a href="/links/">友情链接</a></div>
			...
			<div class="tags">标签：<a href="/links/">友情链接</a> 
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2015-09-07 22:18</li>
				<li>update@ </li>
				<li>阅读(<span id="articleClick">0</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="http://weibo.com/zjj">张静君</a></li>
<li>下一篇：<a href="http://www.applezqp.com">applezqp</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=7&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=http://www.thjy.org';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=6&documentId=7";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
...
<div id="mod32" class="mod click">
    ...
    <div class="cont">
	    <ul>
		    ...
		    <li><a href="/jonllen/aspnet/tinymce.aspx">TinyMce在线编辑器完美打造成Asp.Net服务器自定义控件</a>(31813)</li>
                    
		    <li><a href="/jonllen/js/js-popup.aspx">摆脱JQuery—之自定义模拟弹窗层功能。</a>(25942)</li>
                    
		    <li><a href="/jonllen/aspnet/pd.aspx">使用PowerDesigner的物理模型创建升级管理数据库</a>(23154)</li>
                    
		    <li><a href="/jonllen/aspnet/24.aspx">二次开发WinWebMail邮件系统接口 - 企业邮件服务器解决方案</a>(20313)</li>
                    
		    <li><a href="/jonllen/java/struts.aspx">Struts增删改查实例及源代码下载</a>(19863)</li>
