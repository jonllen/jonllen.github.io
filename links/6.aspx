...
<head>
<title>张静君 - 友情链接 - 金龙博客</title>
<meta name="description" content="http://weibo.com/zjj" />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2015-09-06' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     > <a href="/links/">友情链接</a>
		     > <a href="http://weibo.com/zjj">张静君</a>
		</div>
        <div class="article">
			<div class="title"><h2>张静君</h2></div>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="http://www.fortuneage.com">时代财富</a></li>
<li>下一篇：<a href="http://www.thjy.org">天河部落</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=6&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=http://weibo.com/zjj';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=6&documentId=6";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
