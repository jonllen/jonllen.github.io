...
<head>
<title>java.lang.NoSuchMethodError错误 - Java - 金龙博客</title>
<meta name="description" content="一个错误异常java.lang.NoSuchMethodError，没有这样的方法错误，不过你可别被它的这个名字给忽悠了，因为我明明是有这个方法的，按ALT+S里还有这个方法的智能提示。我觉得这个是TOMCAT的本身的问题，按CTRL+S保存会即时的编译一些代码，但是有时候会出现一些小BUG，想这样的错误关掉TOMCAT重新部署项目后再启动就OK了." />
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/java/17.aspx">java.lang.NoSuchMethodError错误</a>
		</div>
        <div class="article">
			<div class="title"><h2>java.lang.NoSuchMethodError错误</h2></div>
...
<p>严重: Servlet.service() for servlet jsp threw exception<br />java.lang.NoSuchMethodError: bll.ProductBLL.Insert(Ldb/BeanBase;)I<br />&nbsp;at org.apache.jsp.MyJsp_jsp._jspService(org.apache.jsp.MyJsp_jsp:69)<br />&nbsp;at org.apache.jasper.runtime.HttpJspBase.service(HttpJspBase.java:97)<br />&nbsp;at javax.servlet.http.HttpServlet.service(HttpServlet.java:802)<br />&nbsp;at org.apache.jasper.servlet.JspServletWrapper.service(JspServletWrapper.java:332)<br />&nbsp;at org.apache.jasper.servlet.JspServlet.serviceJspFile(JspServlet.java:314)<br />&nbsp;at org.apache.jasper.servlet.JspServlet.service(JspServlet.java:264)<br />&nbsp;at javax.servlet.http.HttpServlet.service(HttpServlet.java:802)<br />&nbsp;at org.apache.catalina.core.ApplicationFilterChain.internalDoFilter(ApplicationFilterChain.java:252)<br />&nbsp;at org.apache.catalina.core.ApplicationFilterChain.doFilter(ApplicationFilterChain.java:173)<br />&nbsp;at appCode.CharacterEncodingFilter.doFilter(CharacterEncodingFilter.java:111)<br />&nbsp;at org.apache.catalina.core.ApplicationFilterChain.internalDoFilter(ApplicationFilterChain.java:202)<br />&nbsp;at org.apache.catalina.core.ApplicationFilterChain.doFilter(ApplicationFilterChain.java:173)<br />&nbsp;at org.apache.catalina.core.StandardWrapperValve.invoke(StandardWrapperValve.java:213)<br />&nbsp;at org.apache.catalina.core.StandardContextValve.invoke(StandardContextValve.java:178)<br />&nbsp;at org.apache.catalina.core.StandardHostValve.invoke(StandardHostValve.java:126)<br />&nbsp;at org.apache.catalina.valves.ErrorReportValve.invoke(ErrorReportValve.java:105)<br />&nbsp;at org.apache.catalina.core.StandardEngineValve.invoke(StandardEngineValve.java:107)<br />&nbsp;at org.apache.catalina.connector.CoyoteAdapter.service(CoyoteAdapter.java:148)<br />&nbsp;at org.apache.coyote.http11.Http11Processor.process(Http11Processor.java:869)<br />&nbsp;at org.apache.coyote.http11.Http11BaseProtocol$Http11ConnectionHandler.processConnection(Http11BaseProtocol.java:667)<br />&nbsp;at org.apache.tomcat.util.net.PoolTcpEndpoint.processSocket(PoolTcpEndpoint.java:527)<br />&nbsp;at org.apache.tomcat.util.net.LeaderFollowerWorkerThread.runIt(LeaderFollowerWorkerThread.java:80)<br />&nbsp;at org.apache.tomcat.util.threads.ThreadPool$ControlRunnable.run(ThreadPool.java:684)<br />&nbsp;at java.lang.Thread.run(Thread.java:595)</p>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2009-06-28 14:16</li>
				<li>update@ 2009-06-28 17:35:07</li>
				<li>阅读(<span id="articleClick">11198</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href=""></a></li>
<li>下一篇：<a href="/jonllen/java/13.aspx">看了自己以前写的一篇文章，感慨万千啊。</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=17&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/java/17.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=17";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
