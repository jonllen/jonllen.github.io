...
<head>
<title>三年 - 心情笔记 - 金龙博客</title>
<meta name="description" content="出来工作已经三年多了，往事并不如烟。本来很早就想写篇这个主题的，但一直没有落定下来，后来看到网上一张相片墙，回想到了自己这三年多来，虽然不堪回首，但还是有很多快乐幸福的回忆，不禁手痒PS出来了一张，感从中来。" />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2011-08-27' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/breast/144.aspx">三年</a>
		</div>
        <div class="article">
			<div class="title"><h2>三年</h2></div>
			...
			<div class="cont" id="content">
				<p>出来工作已经三年多了，往事并不如烟。本来很早就想写篇这个主题的，但一直没有落定下来，后来看到网上一张相片墙，回想到了自己这三年多来，虽然不堪回首，但还是有很多快乐幸福的回忆，不禁手痒PS出来了一张，感从中来。</p>
<div style="display: none;">
<script type="text/javascript">// <![CDATA[
document.write('<a href="/upload/jonllen/upload/3years.png" target="_blank" title="三年"><img src="/upload/jonllen/upload/3years.png" alt="三年" width="480" height="180" /></a>');
// ]]></script>
</div>
<p><strong>三年总结</strong></p>
<p>三年前只身来到广州，在同学帮助下有了个窝，找到了人生第1份工作，拿到到人生的第1笔工资兴奋不已，当时还是懵懵懂懂的，不知道啥是压力。第1家公司工作近1年后，来到现在这家公司，我的视野有了更大的认识，各方面都学到不少，比以前多了一份理性。然后失去了是最初时的那份单纯，多了一份城府。</p>
<p><strong>认识自己</strong></p>
<p>发现自己从来没有总结过自己，有时候也不了解真正的自己。本人性别男爱好女，心悸敏感，闷骚深沉。爱面子，爱虚荣，爱做作，爱拘小结，爱捕风捉影。传统保守，感性胆小，对于不熟悉的人不会有多余的话，对于狐朋狗友方显本性。自控能力较差，时而喜怒形于色。这些也都是别人说的和自己总结出来的，基本上应该八九不离十。当然，对待工作也不会含糊。</p>
<p><strong>工作生活</strong></p>
<p>在我的生活中，基本上与工作不能分开，因为另外一个方面还是一片空白。当年纪渐渐形成了鸭梨，并要在未形成规模的雏形阶段予以解决，当前是历史的关键时期。可惜那方面没天分，那就一门心思努力工作吧。</p>
<p>好吧，又走题了，说了一大篇废话。总结三年，青春蹦溅的三年，理论实践的三年，欢喜多愁的三年。</p>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2011-08-27 14:07</li>
				<li>update@ 2011-09-10 14:12:44</li>
				<li>阅读(<span id="articleClick">7501</span>)</li>
				<li>评论(3)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/breast/142.aspx">2011时代财富11周年年庆</a></li>
<li>下一篇：<a href="/jonllen/breast/146.aspx">2012年的期望</a></li></ul>
		</div>
...
<div class="correlative">
			...
			<div class="commentlist" id="commentContent">
				        ...
				        <div class="item">
					        <div class="desc">
						        ...
						        <a>1楼</a> 文夕 2011-10-19 19:21:01
					        </div><div class="cont">:-)，一口一口把鸭梨吃掉吧。看你总结3年，才想起我毕业4年了……</div>
					        <div class="reply" ><span>回复：</span>是啊,时间过得真快~（2011-10-19 21:46:40）</div>
				        </div>
				        ...
				        <div class="item">
					        <div class="desc">
						        <ul class="options">
							        <li><a href="javascript:;" onclick="quote(this,'仁心博客')">引用</a></li>

						        </ul>
						        <a>3楼</a> 仁心博客 2012-01-01 22:09:38
					        </div><div class="cont">我也想吃鸭梨~！</div>
					        <div class="reply" ><span>回复：</span>呵呵,你博客改版啦?（2012-01-03 12:19:04）</div>
				        </div>
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=144&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/breast/144.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=144";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
