...
<head>
<title>月度工作总结会201003 - 心情笔记 - 金龙博客</title>
<meta name="description" content="我最近的主要工作还是做天河部落的开发，在4月2号的时候已经部署了一个版本到公司的外网服务器，供客户测试。主要完成的是一期的功能点开发，模板完成个人博客、群组和学校的分别2套。我们最终需要完成的模板总数为个人博客12套、群组5套、学校5套，所以在后续的工作里会继续加上还未完成的模板，以及进行天河部落2期功能的开发，包括关键字过滤和Moodle系统等。
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2010-04-07' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/breast/112.aspx">月度工作总结会201003</a>
		</div>
        <div class="article">
			<div class="title"><h2>月度工作总结会201003</h2></div>
			...
			<div class="cont" id="content">
				<p>我最近的主要工作还是做天河部落的开发，在4月2号的时候已经部署了一个版本到公司的外网服务器，供客户测试。主要完成的是一期的功能点开发，模板完成个人博客、群组和学校的分别2套。我们最终需要完成的模板总数为个人博客12套、群组5套、学校5套，所以在后续的工作里会继续加上还未完成的模板，以及进行天河部落2期功能的开发，包括关键字过滤和Moodle系统等。</p>
<p><del>天河部落给我最大的成长，那就是再脱离了Earth老大后，我能直接跟项目那边进行很好的沟通，可以主动去发现一些问题，并能和大家一起讨论，最后解决问题。我觉得这个成长的过程实在太重要了，其中我的技术专业知识也进步了不少。</del></p>
<p>第二段是我后来加上去的，因为那时候杨总说要多谈一点个人的收获和成长，但最后我在发表总结的时候还是删了没说，因为我看到杨总脸色很难看，可能生气了。原因是对建行回来的技术同事工作报告不满意，因为建行的技术同事工作报告里都是说怎么怎么加班，怎么怎么忙碌，好象充满了怨气，看不到团队的战斗力和精神，只说问题，不思考，不想解决办法。Earth老大也被批评了，杨总说管理有问题，怎么在那边就会连一个开会沟通的时间也没有了呢？不过这也难为他们了，因为我之前也去过建行开发中心工作过一段日子，也深深知道在那边工作的压力和艰辛。</p>
<p>这次开会真是被批了，相反的杨总在会上表扬了设计部的2次。他说今天开了4个部门的会议，设计部的同事每个人都谈了自己和团队的成长，差距以及不足。说王册一个月来做了21件事，说那个小女孩提出了一个工作上遇到的问题，后来就召集了几个部门经理应用了Project Manager，说小杨说团队越来越规范，自己都快赶不上&hellip;</p>
<p>这次评选了3月份的优秀员工，我的票数在本部排第二(总共才3个或选人哈)，可惜这个世界的答案只有输和赢，不赢即输，不过我是自愧不如，继续努力。</p>
			</div>
			...
			<div class="tags">标签：<a href="/jonllen/breast/">心情笔记</a> 总结
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2010-04-07 22:18</li>
				<li>update@ </li>
				<li>阅读(<span id="articleClick">7269</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/breast/108.aspx">天河部落额外的收获</a></li>
<li>下一篇：<a href="/jonllen/breast/113.aspx">读王雩老师的《赢在路上》</a></li></ul>
		</div>
...
<div class="correlative">
			...
			<ul>
                    	...
                    	<li><a href='/jonllen/work/145.aspx' title='' target="_blank">2011年度工作总结</a></li>
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=112&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/breast/112.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=112";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
