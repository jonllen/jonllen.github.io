...
<head>
<title>有趣的IE判断 - JavaScript - 金龙博客</title>
<meta name="description" content="var ie = document.all;
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2010-04-26' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/js/117.aspx">有趣的IE判断</a>
		</div>
        <div class="article">
			<div class="title"><h2>有趣的IE判断</h2></div>
			...
			<div class="cont" id="content">
				<p><strong>var ie = document.all;</strong></p>
<p>在以前，如果单只是判断为IE浏览器使用document.all，它返回是文档所有元素数组，可根据数组下标或元素id、name索引元素。这里注意ff等其他非ie浏览器里并不是完全不支持document.all，在quirks模式下使用document.all.id仍然可以获取元素，只不过document.all不能被探知仍然返回false而已。</p>
<p><strong>var ie = !+'\v1';</strong></p>
<p>这是一个仅仅需要7bytes的ie判断，判定借助于IE不支持\v垂直制表符。\v在正则里匹配一个垂直制表符，而在IE里不支持'\v1'被认做为'v1'，而其他浏览器则为'1'，再使用+强制转换为数字，这时IE里就为NaN而其他浏览器则为数字1，最后再加上!强值转换为Boolean类型，此时候IE里就是true而其他浏览器就是false了。</p>
<p>测试：<a href="javascript:alert('\v1');">alert('\v1')</a>(ie:v1,others:1)；<a href="javascript:alert(+'\v1');">alert(+'\v1')</a>(ie:NaN,others:1)；<a href="javascript:alert(!+'\v1');">alert(!+'\v1')</a>(ie:true,others:false)；</p>
<p><strong>var ie = !+[1,];</strong></p>
<p>今天在逛<a href="http://www.cnblogs.com/" target="_blank">园子</a>的时候，发现另外一位童孩<a href="http://www.cnblogs.com/rubylouvre/archive/2010/01/28/1658006.html" target="_blank">全世界最短的IE判定</a>真是强淫，利用了IE与标准浏览器在处理数组的toString方法的差异判定，对于标准游览器，如果数组里面最后一个字符为逗号，JS引擎会自动剔除它，而IE则不会。原来至少需要7bytes，而在今年的1月8日被一个俄国人打破了世界记录，仅仅需要6 bytes！！！</p>
<p>测试：<a href="javascript:alert([1,]);">alert([1,])</a>(ie:[1,undefined],others:[1])；<a href="javascript:alert(+[1,]);">alert(+[1,])</a>(ie:NaN,others:1)；<a href="javascript:alert(!+[1,]);">alert(!+[1,])</a>(ie:true,others:false)；</p>
<p><strong>结束语</strong></p>
<p>JavaScript是一门很有艺术的语言，弱变量类型决定着它产生更多的趣味色彩。所有的JavaScript类型都被转化成Boolean类型，可使用<a href="javascript:alert(!!1);">!!</a>进行强制转换，空字符串、0、null、undefined等都为false，JavaScript为了区分<a href="javascript:alert(0==false);">==</a>还有全等于<a href="javascript:alert(0===false);">===</a>计算符号，以比较两个对象是否全相等。</p>
			</div>
			...
			<div class="tags">标签：<a href="/jonllen/js/">JavaScript</a> ie
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2010-04-26 22:01</li>
				<li>update@ </li>
				<li>阅读(<span id="articleClick">9942</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/js/107.aspx">博客个性化定制(2)-实现类似iGoogle首页功能</a></li>
<li>下一篇：<a href="/jonllen/js/menu.aspx">几种形式的JavaScript树结构菜单</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=117&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/js/117.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=117";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
