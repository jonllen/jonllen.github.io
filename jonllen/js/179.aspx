...
<head>
<title>使用ECharts报表统计公司考勤加班，大家加班多吗？ - JavaScript - 金龙博客</title>
<meta name="description" content="最近个项目已经加班连续加班1个月，因为公司经常有在外面客户现场或出差的情况，人事每个月初会把上个月的份考勤打卡记录全部发出来，让我们对自己的考勤，突然想到可根据大家打卡时间记录统计每天工作时间，看大家加班是否也多呢？然后使用我们现在项目用的ECharts报表来展示，做了个Web的柱状图和饼图分析..." />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2015-06-05' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/js/179.aspx">使用ECharts报表统计公司考勤加班，大家加班多吗？</a>
		</div>
        <div class="article">
			<div class="title"><h2>使用ECharts报表统计公司考勤加班，大家加班多吗？</h2></div>
			...
			<div class="cont" id="content">
				<p>最近个项目已经连续加班1个月多，因为公司经常有在外面客户现场或出差的情况，人事每个月初会把上个月的份考勤打卡记录全部发出来，让我们对自己的考勤，突然想到可根据大家打卡时间记录统计每天工作时间，看大家是否也普遍加班呢？然后使用我们现在项目用的ECharts报表来展示，做了个Web的柱状图和饼图分析，效果如下。</p>
...
// ]]></script>
<p>可以看出，公司超过<strong>3</strong>成的人每天有加班1-6个小时不等。</p>
<p>每天小于8个小时的占比约10%，这是有请假出差或早退的情况；</p>
<p>每天8-9个小时上班的占比约53%，其中超8成半个小时内下班；</p>
<p>每天工作9-10个小时以上的，占比约<strong>25%</strong>；</p>
<p>每天工作11-12个小时以上的，占比约<strong>11%</strong>；</p>
<p>每天13-14个小时以上的，占比近1%，如果是早上9点上班的话，那晚上0点后下班了。</p>
<p><strong>数据分析</strong></p>
<p>报表数据是人事部统计出来的指纹考勤记录的汇总，原始记录是按部门、姓名、日期、签到和签退时间导出Excel的，我这里是公司5月份的指纹考勤记录，我们是每天8小时制弹性上班，上下班时指纹签到和签退，每天工作时间就是签退减去签到再减1.5小时（中午休息时间），然后按工作时间区域分组计算，得到上班的时间和人日天数，作为报表的数据源。</p>
<p>总共统计了公司227个人，有效考勤记录数3642条，排除了周六日和请假出差没签到签退的记录。有的签退时间在0点之后的考勤记录直接计算有问题，我是单独处理了的，如周六日加班有考勤记录的，我是按正常工作日一起汇总算的。</p>
<p>ECharts报表展示效果很不错，使用纯Javascript的图表库，支持PC机和移动设备，兼容IE6+、chrome，firefox，Safari等浏览器。支持多种类型图表和个性化定制功能，我们在项目使用过程中的一些问题ECharts报表基本可以解决，本文示例的报表地址在<a href="/upload/jonllen/case/ECharts.html" target="_blank">/upload/jonllen/case/ECharts.html</a>，打开右击查看源代码。</p>
<p>那么，大家加班多吗？一般要加班多久呢，加班是有加班工资还是调休？</p>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2015-06-05 23:00</li>
				<li>update@ 2015-06-09 23:57:19</li>
				<li>阅读(<span id="articleClick">708</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/js/178.aspx">JavaScript实现SM2算法加解密</a></li>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=179&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/js/179.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=179";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
...
<div id="mod32" class="mod click">
    ...
    <div class="cont">
	    <ul>
		    ...
		    <li><a href="/jonllen/java/struts.aspx">Struts增删改查实例及源代码下载</a>(19712)</li>
