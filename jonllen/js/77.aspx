...
<head>
<title>js取元素和鼠标在页面内的坐标位置 - JavaScript - 金龙博客</title>
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/js/77.aspx">js取元素和鼠标在页面内的坐标位置</a>
		</div>
        <div class="article">
			<div class="title"><h2>js取元素和鼠标在页面内的坐标位置</h2></div>
...
<p style="TEXT-INDENT: 2em"><strong>获取页面元素坐标位置：</strong></p>
<pre><div class="code"><div><span style="color: #0000FF;">function</span><span style="color: #000000;"> elemOffset(elem)<br />{<br />     </span><span style="color: #0000FF;">var</span><span style="color: #000000;"> t </span><span style="color: #000000;">=</span><span style="color: #000000;"> elem.offsetTop;  <br />     </span><span style="color: #0000FF;">var</span><span style="color: #000000;"> l </span><span style="color: #000000;">=</span><span style="color: #000000;"> elem.offsetLeft;  <br />     </span><span style="color: #0000FF;">while</span><span style="color: #000000;">( elem </span><span style="color: #000000;">=</span><span style="color: #000000;"> elem.offsetParent) <br />     {  <br />          t </span><span style="color: #000000;">+=</span><span style="color: #000000;"> elem.offsetTop;  <br />          l </span><span style="color: #000000;">+=</span><span style="color: #000000;"> elem.offsetLeft;  <br />     }<br />     </span><span style="color: #0000FF;">return</span><span style="color: #000000;"> {<br />        x : l ,<br />        y : t<br />     };<br />}</span></div></div></pre>
<p style="TEXT-INDENT: 2em">调用例子：<input type="button" value="点击获取此input的坐标" onclick="alert('X：'+elemOffset(this).x+'，Y：'+elemOffset(this).y)" /></p>
<p style="TEXT-INDENT: 2em"><strong>根据鼠标event事件对象获取坐标位置：</strong></p>
<pre><div class="code"><div><span style="color: #0000FF;">function</span><span style="color: #000000;"> mousePosition(e) <br />{ <br />    </span><span style="color: #0000FF;">if</span><span style="color: #000000;">(e.pageX </span><span style="color: #000000;">&amp;&amp;</span><span style="color: #000000;"> e.pageY) <br />    {<br />        </span><span style="color: #0000FF;">return</span><span style="color: #000000;"> {<br />            x : e.pageX,<br />            y : e.pageY <br />        }; <br />    }<br />    </span><span style="color: #0000FF;">var</span><span style="color: #000000;"> scrollElem </span><span style="color: #000000;">=</span><span style="color: #000000;"> (document.compatMode </span><span style="color: #000000;">&amp;&amp;</span><span style="color: #000000;"> document.compatMode</span><span style="color: #000000;">!=</span><span style="color: #000000;">"</span><span style="color: #000000;">BackCompat</span><span style="color: #000000;">"</span><span style="color: #000000;">)</span><span style="color: #000000;">?</span><span style="color: #000000;"> document.documentElement : document.body;<br />    </span><span style="color: #0000FF;">return</span><span style="color: #000000;"> {<br />        x: e.clientX </span><span style="color: #000000;">+</span><span style="color: #000000;"> scrollElem.scrollLeft,<br />        y: e.clientY </span><span style="color: #000000;">+</span><span style="color: #000000;"> scrollElem.scrollTop<br />    };<br />}</span></div></div></pre>
<p style="TEXT-INDENT: 2em">调用例子：<input type="button" value="获取click事件鼠标的坐标位置" onclick="alert('X：'+mousePosition(event).x+'，Y：'+mousePosition(event).y)" /></p>
<p style="TEXT-INDENT: 2em">整理作者：Jonllen，以上在IE、Firefor3.0、Chrome1.0、Safari4.03、Opera9.64浏览器内测试通过。</p>
</div>
			</div>
			...
			<div class="tags">标签：<a href="/jonllen/js/">JavaScript</a> js元素鼠标位置
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2009-10-21 10:46</li>
				<li>update@ </li>
				<li>阅读(<span id="articleClick">16795</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/js/67.aspx">select</a></li>
<li>下一篇：<a href="/jonllen/js/82.aspx">在线JavaScript调色板</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=77&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/js/77.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=77";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
