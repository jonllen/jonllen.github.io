...
<head>
<title>loadScript和预载图片的JavaScript脚本 - JavaScript - 金龙博客</title>
<meta name="description" content="动态加载自己JavaScript的Ajax请求脚本文件,使用Ajax发送请求..." />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2009-07-24' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/js/47.aspx">loadScript和预载图片的JavaScript脚本</a>
		</div>
        <div class="article">
			<div class="title"><h2>loadScript和预载图片的JavaScript脚本</h2></div>
			...
			<div class="cont" id="content">
				<DIV style="FONT-SIZE: 18px" mce_style="font-size:18px">
<P>加载自己的Ajax请求脚本文件</P>
<DIV class=code>javascript:void(function(url,callback){var script=document.createElement('script');script.type='text/javascript';if(callback)script.onload=script.onreadystatechange=function(){if(script.readyState&amp;&amp;script.readyState!='loaded'&amp;&amp;script.readyState!='complete')return;script.onreadystatechange=script.onload=null;callback();};script.src=url;document.getElementsByTagName('head')[0].appendChild(script);}('http://www.hnonl.com/scripts/Ajax.js',function(){}))</DIV>
<P>使用Ajax发送请求</P>
<DIV class=code>javascript:void(Ajax.send({type:"GET",url:"/",data:"parentId=1529640&amp;blogId=57731&amp;sourceUrl=/&amp;title=document.getElementsByClassName的理想实现-Ruby'sLouvre-博客园&amp;content=document.getElementsByClassName只有IE5不支持?如果要支持层次的筛选就好了,能象jquery那样$('div.class.item')那样来筛选,传一个参数就好了。&amp;parentCommentId=0",fn:function(data){alert(data);},contentType:"application/x-www-form-urlencoded"}))</DIV>
<P>预载图片函数</P>
<DIV class=code><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">function</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;loadImg(src,width,height,callback,parms)<BR>{<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">var</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;imgElem&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">new</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;Image();<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imgElem.style.display&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">"</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">none</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">"</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imgElem.onload&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">function</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(){<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">var</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;loadWidth&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;parseFloat(imgElem.width),&nbsp;loadHeight&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;parseFloat(imgElem.height);<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">var</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;zoomWidth&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;loadWidth,&nbsp;zoomHeight&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;loadHeight;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">if</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">(width&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&amp;&amp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;height&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&amp;&amp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(loadWidth</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&gt;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">width&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">||</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;loadHeight</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&gt;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">height)&nbsp;)<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">if</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">(Math.abs(&nbsp;width</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">-</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">loadWidth)&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&lt;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;Math.abs(&nbsp;height</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">-</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">loadHeight)&nbsp;)<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000">//</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000">宽度不变，等比缩放高度。</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000"><BR></SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomWidth&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;width;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomHeight&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(width</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">*</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">loadHeight)</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">/</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">loadWidth;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000"><BR></SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000">//</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000">高度大于需要高度，继续宽度缩放</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000"><BR></SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">if</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(zoomHeight&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&gt;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;height)<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomWidth&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;width</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">*</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">height</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">/</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">zoomHeight;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000"><BR></SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomHeight&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;height;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">else</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000"><BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomHeight&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;height;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomWidth&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(height</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">*</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">loadWidth)</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">/</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">loadHeight;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000"><BR></SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">if</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(zoomWidth</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&gt;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">width)<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomHeight&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;width</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">*</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">height</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">/</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">zoomWidth;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000"><BR></SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;zoomWidth&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;width;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">if</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(callback)&nbsp;callback(src,zoomWidth,zoomHeight,parms);<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">function</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(){<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imgElem.parentNode.removeChild(imgElem);<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imgElem&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">null</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">0</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">);<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;};<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imgElem.src&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;src;<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;imgElem.onabort&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;</SPAN><SPAN style="COLOR: #0000ff" mce_style="color: #0000ff">function</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;(){&nbsp;imgElem.src&nbsp;</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">=</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;imgElem.src;&nbsp;};<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000">//</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000">imgElem.onreadystatechange=function(){&nbsp;if&nbsp;(imgElem.readyState=="complete")&nbsp;{}&nbsp;}</SPAN><SPAN style="COLOR: #008000" mce_style="color: #008000"><BR></SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;document.body.insertBefore(imgElem,document.body.childNodes[</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">0</SPAN><SPAN style="COLOR: #000000" mce_style="color: #000000">]);<BR>}</SPAN> </DIV></DIV>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2009-07-24 10:51</li>
				<li>update@ 2009-07-26 15:09:33</li>
				<li>阅读(<span id="articleClick">11391</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/js/45.aspx">JavaScript兼容笔记</a></li>
<li>下一篇：<a href="/jonllen/js/64.aspx">在线JavaScript编码和解码</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=47&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/js/47.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=47";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
