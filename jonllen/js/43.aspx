...
<head>
<title>网页版弹钢琴&&滚动的音符 - JavaScript - 金龙博客</title>
<meta name="description" content="网页版弹钢琴&&JQuery滚动的音符..." />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2009-07-16' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/js/43.aspx">网页版弹钢琴&&滚动的音符</a>
		</div>
        <div class="article">
			<div class="title"><h2>网页版弹钢琴&&滚动的音符</h2></div>
			...
			<div class="cont" id="content">
				<style type="text/css">
     .removefloat {clear:both; font-size:0px; height:0px; line-height:0px; display:block;}
	 #MusicPanel #note{width: 100%; height:150px; overflow:hidden;}
     #MusicPanel #note .column {margin:auto 2px; float:left;width:8px;}
     #MusicPanel #note .head {height:8px;font-size:8px;border:solid 1px #cccccc;line-height:8px;cursor:pointer;}
     #MusicPanel #note .item {height:150px;border:solid 1px #cccccc;margin:0px auto;display:none;}
     #MusicPanel #note .foot{height:5px;font-size:0;border:solid 1px #cccccc;cursor:pointer;}
</style>
<div style="margin: 0px auto; width:498px; position: relative; border: #cccccc 1px dashed;" id="MusicPanel">
    <div id="note"></div>
    <div class="removefloat"></div>
</div>
<div style="width:500px; margin:0 auto;">
	<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="500" height="380">
		<param name="allowScriptAccess" value="sameDomain" />
		<param name="movie" value="/upload/jonllen/media/piano.swf" />
		<param name="quality" value="high" />
		<param name="bgcolor" value="#ff6600" />
		<param name="menu" value="false" />
		<param name="wmode" value="transparent" />
		<embed src="/upload/jonllen/media/piano.swf" quality="high" allowscriptaccess="sameDomain" type="application/x-shockwave-flash" wmode="transparent" pluginspage="http://www.macromedia.com/go/getflashplayer" width="500" height="380"></embed>
	</object>
</div>
<script src="/scripts/jquery.js" type="text/javascript"></script>
<script type="text/javascript">
        var arr = [ "FF", "CC", "99", "33", "00" ];
        var columnscount=arr.length,requirecount=15,i=1,currentid=65;
        function test()
        {
            for(var r=0;r<columnscount;r++)
            {
                for(var g=0;g<columnscount-1;g++)
                {
                    for(var b=0;b<columnscount-2;b++)
                    {
                        var color = "#"+arr[r]+arr[g]+arr[b];
                        //if(color=="#FFFFFF") break;
                        ...
                        item.className="item";
                        item.setAttribute("id",String.fromCharCode(currentid));
                        ...
                        $(foot).hover(function (){
                            $(this).prev().children(".item").show(1000);
                        },function (){
                            $(this).prev().children(".item").hide(1000);
                        });
                        
                        //给column添加click事件
                        $(column).toggle(function (){
                            $(this).children(":first").find(".item").show(1000);
                        },function (){
                            $(this).children(":first").find(".item").hide(1000);
                        });
                        
                        document.getElementById("note").appendChild(column);
                        
                        if(String.fromCharCode(currentid)=="z") return;
                        else currentid++;
                    }
                }
            }
        ...
        function keydown(e)
        {
            ...
            if( num>=49 && num<=57 )//为住键盘区数字
                $("#note .column div .head:contains("+(num-48)+")").next(".item").show(500);
            else if( num>=97 && num<=105 )//小键盘的数字区
                $("#note .column div .head:contains("+(num-96)+")").next(".item").show(500);
            else{ $("#note .column div #"+String.fromCharCode(num)+",#"+String.fromCharCode(num).toLowerCase()).show(500);}
        ...
        {   
            ...
            var numcheck =/\d/;
            if( num>=49 && num<=57 )//为住键盘区数字
                $("#note .column div .head:contains("+(num-48)+")").next(".item").hide(500);
            else if( num>=97 && num<=105 )//小键盘的数字区
                $("#note .column div .head:contains("+(num-96)+")").next(".item").hide(500);
            else $("#note .column div #"+String.fromCharCode(num)+",#"+String.fromCharCode(num).toLowerCase()).hide(500);
        }
        
        window.onload = function (){
            test();
            var target = document.all ? document.body : window;
            //target.onkeydown = function (e){ keydown(e);};
            //target.onkeyup = function (e){keyup(e);};
            $(target).keydown(function (e){ keydown(e); });
            $(target).keyup(function (e){ keyup(e); });
...
<div style="font-size:16px; width:500px; margin:0 auto;">
	<h4>音谱</h4>
	<p>童话</p>
	<p>&#160;&#160;&#160; lonol lonol lono oomml<br />
	  lonol lqppo lonom mmots<br />
	  pprrqq qqnpoono onor lsrqp<br />
	  pprrqq qqvutuv vpot ttsss<br />
	  lsrqqrq qrq rqpo<br />
	  oqst ttspprq oqst<br />
	  ttspprqrqpo pqmmoono</p>
	<p> 月亮代表我的心</p>
	<p>&#160;&#160;&#160; loqsonqs stuvts qpooo qpooo pqpompqp<br />
	  loqsonqs stuvts qpooo qpooo pqpmnopo<br />
	  qsqposn mnmnmlq sqposn mnooopqp<br />
	  loqsonqs stuvts qpooo qpooo pqpmnopo</p>
	<p>欢乐颂</p>
	<p>&#160;&#160;&#160; j j k l l k j i h h i j j i i<br />
	  j j k l l k j i h h i j i h h<br />
	  i i j h i j k j h i j k j i h i e<br />
	  j j k l l k j i h h i j i h h </p>
	<p>小星星</p>
	<p>&#160;&#160;&#160; oosstts rrqqppo<br />
	  ssrrqqp ssrrqqp<br />
	  oosstts rrqqppo</p>
	<p>千千阙歌</p>
	<p>&#160;&#160;&#160; hhij lmonnnlj<br />
	  ...
	  hhij lmonnnlj<br />
	  iiijk moqppnl<br />
	  mlmlmnnmn ppppnopq<br />
	  qqpppoq nlm<br />
	  lmopqqpq qpop omm<br />
	  lmop qqpq qstsqq<br />
	  qqppopom qqrqpop qq q p<br />
	  pop omoo</p>
	<p>婚礼进行曲</p>
	<p>&#160;&#160;&#160; hkkk hljk hknnmlkjkl<br />
	  hkkk hljk hkmomkilmk<br />
	  nmlii jkll nmlii jkll<br />
	  hkkk hljk hkmomkilmk<br />
	  ilmkk </p>
	<p>樱花</p>
	<p>&#160;&#160;&#160; mmn mmn<br />
	  ...
	  jknmk j</p>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2009-07-16 21:26</li>
				<li>update@ 2010-02-11 16:26:45</li>
				<li>阅读(<span id="articleClick">17804</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/js/41.aspx">摆脱JQuery—之自定义Dom筛选器</a></li>
<li>下一篇：<a href="/jonllen/js/45.aspx">JavaScript兼容笔记</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=43&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/js/43.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=43";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
