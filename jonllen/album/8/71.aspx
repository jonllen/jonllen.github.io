		...
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     ...
			     > <a id='currentLink' href='/jonllen/album/8/71.aspx'>拳击</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/网络收藏/633883905827656250_拳击.jpg" /></div>
			    <div class="name"><strong id="currentName">拳击</strong><a href="/upload/jonllen/album/网络收藏/633883905827656250_拳击.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">拳击</span></dd>
					    <dd>上传时间：<span id="spanTime">2009-09-12 22:16:22.0</span></dd>
					    <dd>浏览次数：<span id="spanClick">100</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='71'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=71&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/8/71.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=71";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
