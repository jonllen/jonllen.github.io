		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2009-10-01' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="photo">
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     > <a href="../">我的相册</a>
			     > <a href="/jonllen/album/8/">网络收藏</a>
			     > <a id='currentLink' href='/jonllen/album/8/73.aspx'>盛装舞步(骑术)</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/网络收藏/633883905828437500_盛装舞步(骑术).jpg" /></div>
			    <div class="name"><strong id="currentName">盛装舞步(骑术)</strong><a href="/upload/jonllen/album/网络收藏/633883905828437500_盛装舞步(骑术).jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">盛装舞步(骑术)</span></dd>
					    <dd>上传时间：<span id="spanTime">2009-09-12 22:16:22.0</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='73'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=73&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/8/73.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=73";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
...
photo.push( { id : 69, name : '花剑', title : '花剑', time : '2009-09-12 22:16:22.0', click : 151, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883905826718750_花剑.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883905826718750_花剑.jpg', 'link' : '/jonllen/album/8/69.aspx' } );

photo.push( { id : 70, name : '举重', title : '举重', time : '2009-09-12 22:16:22.0', click : 112, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883905827187500_举重.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883905827187500_举重.jpg', 'link' : '/jonllen/album/8/70.aspx' } );

photo.push( { id : 71, name : '拳击', title : '拳击', time : '2009-09-12 22:16:22.0', click : 100, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883905827656250_拳击.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883905827656250_拳击.jpg', 'link' : '/jonllen/album/8/71.aspx' } );

photo.push( { id : 72, name : '射击', title : '射击', time : '2009-09-12 22:16:22.0', click : 116, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883905828125000_射击.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883905828125000_射击.jpg', 'link' : '/jonllen/album/8/72.aspx' } );

photo.push( { id : 73, name : '盛装舞步(骑术)', title : '盛装舞步(骑术)', time : '2009-09-12 22:16:22.0', click : 131, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883905828437500_盛装舞步(骑术).jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883905828437500_盛装舞步(骑术).jpg', 'link' : '/jonllen/album/8/73.aspx' } );

photo.push( { id : 74, name : '跆拳道', title : '跆拳道', time : '2009-09-12 22:16:22.0', click : 111, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883905828906250_跆拳道.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883905828906250_跆拳道.jpg', 'link' : '/jonllen/album/8/74.aspx' } );

photo.push( { id : 75, name : '体操', title : '体操', time : '2009-09-12 22:17:41.0', click : 110, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883906611250000_体操.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883906611250000_体操.jpg', 'link' : '/jonllen/album/8/75.aspx' } );

photo.push( { id : 76, name : '跳水', title : '跳水', time : '2009-09-12 22:17:41.0', click : 115, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883906611406250_跳水.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883906611406250_跳水.jpg', 'link' : '/jonllen/album/8/76.aspx' } );

photo.push( { id : 77, name : '游泳', title : '游泳', time : '2009-09-12 22:17:41.0', click : 130, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883906611406250_游泳.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883906611406250_游泳.jpg', 'link' : '/jonllen/album/8/77.aspx' } );

photo.push( { id : 78, name : '小猪', title : '小猪', time : '2009-09-12 22:28:13.0', click : 98, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883912931875000_小猪.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883912931875000_小猪.jpg', 'link' : '/jonllen/album/8/78.aspx' } );

photo.push( { id : 79, name : '最爱JAY', title : '最爱JAY', time : '2009-09-12 22:29:26.0', click : 125, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883913667500000_最爱JAY.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883913667500000_最爱JAY.jpg', 'link' : '/jonllen/album/8/79.aspx' } );

photo.push( { id : 80, name : '叶 惠 美', title : '叶 惠 美', time : '2009-09-12 22:29:26.0', click : 121, reviewCount : 0, src : '/upload/jonllen/album/网络收藏/633883913667656250_叶 惠 美.jpg?width=74', rawSrc : '/upload/jonllen/album/网络收藏/633883913667656250_叶 惠 美.jpg', 'link' : '/jonllen/album/8/80.aspx' } );
