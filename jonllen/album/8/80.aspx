		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2009-11-07' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
		...
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     ...
			     > <a id='currentLink' href='/jonllen/album/8/80.aspx'>叶 惠 美</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/网络收藏/633883913667656250_叶 惠 美.jpg" /></div>
			    <div class="name"><strong id="currentName">叶 惠 美</strong><a href="/upload/jonllen/album/网络收藏/633883913667656250_叶 惠 美.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">叶 惠 美</span></dd>
					    <dd>上传时间：<span id="spanTime">2009-09-12 22:29:26.0</span></dd>
					    <dd>浏览次数：<span id="spanClick">121</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='80'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=80&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/8/80.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=80";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
