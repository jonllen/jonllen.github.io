		...
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     ...
			     > <a id='currentLink' href='/jonllen/album/4/16.aspx'>长廊</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/天河公园/633824089066718750_长廊.jpg" /></div>
			    <div class="name"><strong id="currentName">长廊</strong><a href="/upload/jonllen/album/天河公园/633824089066718750_长廊.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">长廊</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='16'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=16&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/4/16.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=16";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
