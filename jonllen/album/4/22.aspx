    ...
    <div class="photo">
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     > <a href="../">我的相册</a>
			     > <a href="/jonllen/album/4/">天河公园</a>
			     > <a id='currentLink' href='/jonllen/album/4/22.aspx'>全景</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/天河公园/633824089069531250_全景.jpg" /></div>
			    <div class="name"><strong id="currentName">全景</strong><a href="/upload/jonllen/album/天河公园/633824089069531250_全景.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">全景</span></dd>
					    <dd>上传时间：<span id="spanTime">2009-07-05 16:41:46.0</span></dd>
					    <dd>浏览次数：<span id="spanClick">194</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='22'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=22&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/4/22.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=22";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
...
photo.push( { id : 16, name : '长廊', title : '长廊', time : '2009-07-05 16:41:46.0', click : 184, reviewCount : 0, src : '/upload/jonllen/album/天河公园/633824089066718750_长廊.jpg?width=74', rawSrc : '/upload/jonllen/album/天河公园/633824089066718750_长廊.jpg', 'link' : '/jonllen/album/4/16.aspx' } );

photo.push( { id : 18, name : '湖面', title : '湖面', time : '2009-07-05 16:41:46.0', click : 152, reviewCount : 0, src : '/upload/jonllen/album/天河公园/633824089067656250_湖面.jpg?width=74', rawSrc : '/upload/jonllen/album/天河公园/633824089067656250_湖面.jpg', 'link' : '/jonllen/album/4/18.aspx' } );

photo.push( { id : 19, name : '阶梯', title : '阶梯', time : '2009-07-05 16:41:46.0', click : 158, reviewCount : 0, src : '/upload/jonllen/album/天河公园/633824089068125000_阶梯.jpg?width=74', rawSrc : '/upload/jonllen/album/天河公园/633824089068125000_阶梯.jpg', 'link' : '/jonllen/album/4/19.aspx' } );

photo.push( { id : 20, name : '绿幽', title : '绿幽', time : '2009-07-05 16:41:46.0', click : 153, reviewCount : 0, src : '/upload/jonllen/album/天河公园/633824089068593750_绿幽.jpg?width=74', rawSrc : '/upload/jonllen/album/天河公园/633824089068593750_绿幽.jpg', 'link' : '/jonllen/album/4/20.aspx' } );

photo.push( { id : 21, name : '貌似海南', title : '貌似海南', time : '2009-07-05 16:41:46.0', click : 137, reviewCount : 0, src : '/upload/jonllen/album/天河公园/633824089069062500_貌似海南.jpg?width=74', rawSrc : '/upload/jonllen/album/天河公园/633824089069062500_貌似海南.jpg', 'link' : '/jonllen/album/4/21.aspx' } );

photo.push( { id : 22, name : '全景', title : '全景', time : '2009-07-05 16:41:46.0', click : 194, reviewCount : 1, src : '/upload/jonllen/album/天河公园/633824089069531250_全景.jpg?width=74', rawSrc : '/upload/jonllen/album/天河公园/633824089069531250_全景.jpg', 'link' : '/jonllen/album/4/22.aspx' } );
