...
<head>
<title>chapter1-300x212 - 海派甜心 - 金龙博客</title>
		...
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     ...
			     > <a id='currentLink' href='/jonllen/album/11/102.aspx'>chapter1-300x212</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/海派甜心/chapter1-300x212.jpg" /></div>
			    <div class="name"><strong id="currentName">chapter1-300x212</strong><a href="/upload/jonllen/album/海派甜心/chapter1-300x212.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">chapter1-300x212</span></dd>
					    <dd>上传时间：<span id="spanTime">2010-02-07 19:36:41.0</span></dd>
					    <dd>浏览次数：<span id="spanClick">117</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='102'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=102&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/11/102.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=102";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
