...
<head>
<title>海派漫畫第11集-300x200 - 海派甜心 - 金龙博客</title>
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2010-03-27' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
		...
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     ...
			     > <a id='currentLink' href='/jonllen/album/11/111.aspx'>海派漫畫第11集-300x200</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/海派甜心/海派漫畫第11集-300x200.jpg" /></div>
			    <div class="name"><strong id="currentName">海派漫畫第11集-300x200</strong><a href="/upload/jonllen/album/海派甜心/海派漫畫第11集-300x200.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">海派漫畫第11集-300x200</span></dd>
					    <dd>上传时间：<span id="spanTime">2010-02-07 19:36:41.0</span></dd>
					    <dd>浏览次数：<span id="spanClick">155</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='111'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=111&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/11/111.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=111";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
