		...
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     ...
			     > <a id='currentLink' href='/jonllen/album/10/94.aspx'>夕阳西下</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/科韵路/夕阳西下.jpg" /></div>
			    <div class="name"><strong id="currentName">夕阳西下</strong><a href="/upload/jonllen/album/科韵路/夕阳西下.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">夕阳西下</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='94'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=94&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/10/94.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=94";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
