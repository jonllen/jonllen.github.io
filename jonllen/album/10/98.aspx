    ...
    <div class="photo">
		<div class="title">
		    <strong>当前位置：</strong>
			    <a href="/">首页</a>
			     > <a href="../">我的相册</a>
			     > <a href="/jonllen/album/10/">科韵路</a>
			     > <a id='currentLink' href='/jonllen/album/10/98.aspx'>我的电脑</a>
		</div>
		<div class="cont">
		    <div class="fixfloat">
			...
			<div id="miniaturebody">
			    <div class="pic"><img id="imgCurrent" src="/upload/jonllen/album/科韵路/我的电脑.jpg" /></div>
			    <div class="name"><strong id="currentName">我的电脑</strong><a href="/upload/jonllen/album/科韵路/我的电脑.jpg" id="imgOriginality" target="_blank" class="originality">原图</a></div>
			    <div class="detail">
				    <dl>
					    <dd>名　　称：<span id="spanName">我的电脑</span></dd>
					    <dd>上传时间：<span id="spanTime">2009-11-16 20:32:16.0</span></dd>
					    <dd>浏览次数：<span id="spanClick">175</span></dd>
...
<div class="commentlist" id="commentContent">
	...
	<script type="text/javascript">
		...
		photo.eClick = function (img){
		    ...
		    if(img.id!='98'){location=img.link;}
		...
		{
		    var url = "/plugin/web/doSaveComment.do?sourcetype=2&sourceid=98&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/album/10/98.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=2&documentId=98";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
...
photo.push( { id : 92, name : '窗外', title : '窗外', time : '2009-11-16 20:31:23.0', click : 113, reviewCount : 0, src : '/upload/jonllen/album/科韵路/窗外.jpg?width=74', rawSrc : '/upload/jonllen/album/科韵路/窗外.jpg', 'link' : '/jonllen/album/10/92.aspx' } );

photo.push( { id : 93, name : '星星灯火', title : '星星灯火', time : '2009-11-16 20:31:23.0', click : 188, reviewCount : 0, src : '/upload/jonllen/album/科韵路/星星灯火.jpg?width=74', rawSrc : '/upload/jonllen/album/科韵路/星星灯火.jpg', 'link' : '/jonllen/album/10/93.aspx' } );

photo.push( { id : 94, name : '夕阳西下', title : '夕阳西下', time : '2009-11-16 20:31:23.0', click : 122, reviewCount : 0, src : '/upload/jonllen/album/科韵路/夕阳西下.jpg?width=74', rawSrc : '/upload/jonllen/album/科韵路/夕阳西下.jpg', 'link' : '/jonllen/album/10/94.aspx' } );

photo.push( { id : 95, name : '远景', title : '远景', time : '2009-11-16 20:31:24.0', click : 107, reviewCount : 0, src : '/upload/jonllen/album/科韵路/远景.jpg?width=74', rawSrc : '/upload/jonllen/album/科韵路/远景.jpg', 'link' : '/jonllen/album/10/95.aspx' } );

photo.push( { id : 96, name : '科韵路', title : '科韵路', time : '2009-11-16 20:31:24.0', click : 142, reviewCount : 0, src : '/upload/jonllen/album/科韵路/科韵路.jpg?width=74', rawSrc : '/upload/jonllen/album/科韵路/科韵路.jpg', 'link' : '/jonllen/album/10/96.aspx' } );

photo.push( { id : 97, name : '绿道', title : '绿道', time : '2009-11-16 20:32:16.0', click : 109, reviewCount : 0, src : '/upload/jonllen/album/科韵路/绿道.jpg?width=74', rawSrc : '/upload/jonllen/album/科韵路/绿道.jpg', 'link' : '/jonllen/album/10/97.aspx' } );

photo.push( { id : 98, name : '我的电脑', title : '我的电脑', time : '2009-11-16 20:32:16.0', click : 175, reviewCount : 0, src : '/upload/jonllen/album/科韵路/我的电脑.jpg?width=74', rawSrc : '/upload/jonllen/album/科韵路/我的电脑.jpg', 'link' : '/jonllen/album/10/98.aspx' } );
