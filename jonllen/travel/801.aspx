...
<head>
<title>靖港古镇游 - 旅游 - 金龙博客</title>
<meta name="description" content="之前在长沙工作的同事，说过几次靖港古镇，周末时候，天气还好就跑去了靖港古镇看看。从汽车西站出发，走雷锋大道一路向北，到靖港西边的停车场刚一个小时车程。靖港古镇从西到东一条街旁边都是古建筑，还是有些特色味道，走到最东边已经到了湘江边，一路走走看看大约1个小时。" />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2015-11-29' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     > <a href="/jonllen/travel/">旅游</a>
		     > <a href="/jonllen/travel/801.aspx">靖港古镇游</a>
		</div>
        <div class="article">
			<div class="title"><h2>靖港古镇游</h2></div>
			<div class="category">分类：<a href="/jonllen/travel/">旅游</a></div>
			...
			<div class="cont" id="content">
				<p>之前在长沙工作的同事，说过几次靖港古镇，周末时候，天气还好就跑去了靖港古镇看看。从汽车西站出发，走雷锋大道一路向北，到靖港西边的停车场刚一个小时车程。靖港古镇从西到东一条街旁边都是古建筑，还是有些特色味道，走到最东边已经到了湘江边，一路走走看看大约1个小时。</p>
<p>靖港古镇是免费开放的，只是里面有景点需要门票。下面这个是古代的青楼，这个就是需要买门票参观。</p>
<div><img rawsrc="/jonllen/travel/a/A801_1454224771329.jpg" alt="古代青楼" /></div>
<p>靖港里面的一条小河小桥。</p>
<div><img rawsrc="/jonllen/travel/a/A801_1454224771742.jpg" alt="小桥流水" /></div>
<p>御绣如意</p>
<div><img rawsrc="/jonllen/travel/a/A801_1454224771759.jpg" alt="御绣如意" /></div>
<p>气味博物馆，给人一种清新感觉~</p>
<div><img rawsrc="/jonllen/travel/a/A801_1454224771763.jpg" alt="气味博物馆" /></div>
<p>靖港古镇里街道</p>
<div><img rawsrc="/jonllen/travel/a/A801_1454224771774.jpg" alt="古镇街道" /></div>
<p>靖港里面有很多小吃店，我们在路上喝了热纯牛奶，还看到了些现在做小花片的店子，蛮有意思的~</p>
<div><img rawsrc="/jonllen/travel/a/A801_1454227552158.jpg" alt="靖港彭记特色小吃" /></div>
<p>里面吃饭也有店子，不过我们中午还是点了些小吃，混沌、臭豆腐、糍粑，消费还是比较实惠。</p>
<div><img rawsrc="/jonllen/travel/a/A801_1454224771778.jpg" alt="喵眯" /></div>
<p>最后一张是我自己，感觉这2只带红领巾的喵眯太可爱了，呵呵。如果在长沙没有去过靖港古镇，我觉得还是值得一去。</p>
			</div>
			...
			<div class="tags">标签：<a href="/jonllen/travel/">旅游</a> 
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2015-11-29 14:41</li>
				<li>update@ 2016-01-31 16:10:56</li>
				<li>阅读(<span id="articleClick">1</span>)</li>
				<li>评论(0)</li>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=801&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/travel/801.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=801";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
...
<div id="mod32" class="mod click">
    ...
    <div class="cont">
	    <ul>
		    ...
		    <li><a href="/jonllen/aspnet/tinymce.aspx">TinyMce在线编辑器完美打造成Asp.Net服务器自定义控件</a>(31845)</li>
                    
		    <li><a href="/jonllen/js/js-popup.aspx">摆脱JQuery—之自定义模拟弹窗层功能。</a>(25956)</li>
                    
		    <li><a href="/jonllen/aspnet/pd.aspx">使用PowerDesigner的物理模型创建升级管理数据库</a>(23168)</li>
                    
		    <li><a href="/jonllen/aspnet/24.aspx">二次开发WinWebMail邮件系统接口 - 企业邮件服务器解决方案</a>(20343)</li>
                    
		    <li><a href="/jonllen/java/struts.aspx">Struts增删改查实例及源代码下载</a>(19876)</li>
