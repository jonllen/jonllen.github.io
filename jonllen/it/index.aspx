...
<script type='text/javascript'>function goToPage0(pid, urlformat){var url = "/jonllen/it/index__pid.aspx";if(urlformat)url=urlformat;document.location.replace(url.replace("_pid",pid).replace("_1.","."));}</script>
	</div>
