...
<head>
<title>14日起个人用户无法申请注册CN域名 - 业界 - 金龙博客</title>
<meta name="description" content="中国互联网络信息中心(CNNIC)对加强域名监管再出重击，于11日晚间发公告称从今日(12月14日)9时起，用户注册.CN域名需提交书面申请，之前用户网上申请即可；并停止个人用户域名注册。CNNIC负责人表示，我国一直未开放过个人域名注册，但存在用户利用虚假资料注册并获得个人域名的行为。" />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2009-12-14' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/it/110.aspx">14日起个人用户无法申请注册CN域名</a>
		</div>
        <div class="article">
			<div class="title"><h2>14日起个人用户无法申请注册CN域名</h2></div>
			...
			<div class="cont" id="content">
				<p>中国互联网络信息中心(CNNIC)对加强域名监管再出重击，于11日晚间发公告称从今日(12月14日)9时起，用户注册.CN域名需提交书面申请，之前用户网上申请即可；并&ldquo;停止&rdquo;个人用户域名注册。CNNIC负责人表示，我国一直未开放过个人域名注册，但存在用户利用虚假资料注册并获得个人域名的行为。</p>
<p><strong>需提交书面申请及企业资料</strong></p>
<p>CNNIC公告要求用户向域名注册服务机构在线提交域名注册申请的同时，应当提交书面申请材料。申请材料包括加盖公章的域名注册申请表(原件)、企业营业执照或组织机构代码证(复印件)、注册联系人身份证明(复印件)。而这代表着，没有企业营业执照或组织机构代码证的个人用户，将无法申请注册域名。</p>
<p>根据公告，除了要提交上述书面材料之外，CNNIC还要求域名注册服务机构认真审核用户提交的书面申请材料，审核合格后，将书面申请材料通过传真或电子邮件的形式提交至CNNIC，并保留书面申请资料。如果自域名提交在线申请之日起5日内CNNIC未收到书面申请材料的或域名申请材料审核不符合条件的，该域名将予以注销。</p>
<p>有业内人士称，在此之前对于域名申请虽也有相关规定，但CNNIC及其代理机构并未认真执行，用户申请域名时在网上提交申请即可，而域名注册机构对用户提交的信息审查并不严格，甚至部分机构帮助用户利用虚假信息注册域名。以企业为主体进行注册，将会增加违规的成本，从而抑制这种行为。</p>
<p><strong>个人域名注册一直未开放</strong></p>
<p>CNNIC副主任刘志江表示：&ldquo;过去确实存在个人用户，以个人名义或别的方式，注册域名。现在根据专项治理要求，我们要加强信息核查，要求申请域名时同时提交书面材料，所以个人用户确实无法注册域名了。&rdquo;据了解我国管理政策确实一直没有允许个人注册域名。</p>
<p>由于手机网站涉黄问题严重，此次发布的公告主要是为了通过提高域名注册信息的真实度，来减少域名非法应用问题。&ldquo;以前用户注册只是通过网站填写申请材料，提交书面申请可以让我们在审查中提高准确率。&rdquo;刘志江解释。事实上在2002年以前用户申请域名一直都需提交书面申请。</p>
<p>由于此次CNNIC的严查主要目的是打击涉黄网站，因此该公告主要针对新注册用户提出要求。</p>
<p><strong>不会贸然关闭已注册域名</strong></p>
<p>据悉，CNNIC此次整治分两大块。</p>
<p>一块是针对已申请CN域名的用户，CNNIC将重点审查这些域名所指网站是否涉黄或者从事其他违法行为。另一块则针对新申请域名的用户，正如公告所示，要求用户提交书面申请材料以及要求域名注册服务机构加强审核。</p>
<p>不过更让许多用户关心的是，如果个人已经注册了.CN域名，是否也会在此次审查风暴中被封杀。对此，刘志江表示，目前审查主要针对违法涉黄行为，如果个人已经注册域名，使用目的合法合理，这些用户的合法利益也会予以保护。&ldquo;对于合法使用的网站，我们不会贸然关闭。如有信息不准确问题，要停止域名解析，CNNIC也会提前与用户联系，并给其留出充分的修改完善的时间。&rdquo;</p>
<p>不过据了解到，目前已注册.CN的用户数量有1300万之巨，因此此次审查也将是一项艰巨的浩大工程。</p>
<p><strong>事件回放</strong></p>
<p>12月9日晚，央视报道，从事手机色情网站运营的犯罪嫌疑人通过CNNIC授权的域名注册机构或代理机构注册大量域名，将其指向黄色网站。</p>
<p>12月10日，中国域名监管机构CNNIC发出通知，要求在域名注册服务过程中，域名注册用户、受理域名注册申请的相关人员、代理商等都需负起相应责任，保证域名注册信息真实、准确、完整，并将对已注册的域名注册信息进行逐个审核。</p>
<p>12月10日，发出处罚公告，叫停新网等三家服务商的域名注册业务。</p>
<p>12月11日晚，CNNIC又发出公告，要求用户注册CN域名需提交书面申请。</p>
<p><img src="/upload/jonllen/article/cn.jpg" /></p>
			</div>
			...
			<div class="tags">标签：<a href="/jonllen/it/">业界</a> 域名
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2009-12-14 11:42</li>
				<li>update@ </li>
				<li>阅读(<span id="articleClick">6794</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href=""></a></li>
<li>下一篇：<a href="/jonllen/it/109.aspx">谷歌今日宣布退出中国内地</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=110&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/it/110.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=110";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
