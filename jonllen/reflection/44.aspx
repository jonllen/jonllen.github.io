...
<head>
<title>项目里面至关重要的东西—细节 - 三日必省吾身 - 金龙博客</title>
<meta name="description" content="今天不知道为什么，感觉好象很浮躁，早上一来Earth就重新发布我昨天修改完成的广佛都市网积分等级的功能，问题一大推，他先后叫我2次到他那边去问话，跟我说一些问题...
" />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2009-07-17' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/reflection/44.aspx">项目里面至关重要的东西—细节</a>
		</div>
        <div class="article">
			<div class="title"><h2>项目里面至关重要的东西—细节</h2></div>
...
<p style="text-indent: 2em;" mce_style="text-indent:2em">今天不知道为什么，感觉好象很浮躁，早上一来Earth就重新发布我昨天修改完成的广佛都市网积分等级的功能，问题一大推，他先后叫我2次到他那边去问话，跟我说一些问题。</p>
<ol style="margin: 1em; padding: 1em;" mce_style="padding:1em;margin:1em;">
<li>用户积分登记在那里同步修改的，怎么没看见？回：在User里的UpdateUserPointInfo方法里，添加积分的时候都会调用这个方法，顺便多更新积分等级和级别名称字段;</li>
<li>这样做不行，既然修改了数据库里面字段，为什么没把User里对象属性字段一起更新，不然别人调用的时候会有问题的;</li>
<li>后台怎么还用缓存呢？还加2个小时...</li>
<li>Shit，数据库字段名改了，怪不得更新的正式服务器上报错，但是GridView绑定找不到这个字段竟然不报错...</li>
</ol>
<p style="text-indent: 2em;" mce_style="text-indent:2em">总结，现在广佛都市网已将到工期结束时段，这个时候我们更应该去注意一些细节的东西了，而我现在做出来的程序质量真的还需要提升，每次我实现一个功能都需要跟地球去汇报一下，然后他会去测试看一下我写的东西，总能挑出一些毛病，所有我这方面还需要加强啊！</p>
<p style="text-indent: 2em; text-align: right;" mce_style="text-indent: 2em; text-align: right;"><span style="color: rgb(255, 0, 0);" mce_style="color: #ff0000;">——加油</span></p>
</div>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2009-07-17 14:48</li>
				<li>update@ 2009-07-17 14:58:40</li>
				<li>阅读(<span id="articleClick">9575</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href=""></a></li>
<li>下一篇：<a href="/jonllen/reflection/68.aspx">关于IE6的老掉牙select问题</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=44&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/reflection/44.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=44";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
