...
<head>
<title>总结今年的几个项目案例 - 工作 - 金龙博客</title>
<meta name="description" content="一、广佛都市网
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2010-01-04' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/work/98.aspx">总结今年的几个项目案例</a>
		</div>
        <div class="article">
			<div class="title"><h2>总结今年的几个项目案例</h2></div>
...
<p style="text-indent: 2em;"><strong>一、广佛都市网</strong></p>
<p style="text-indent: 2em;"><a target="_blank" href="http://www.citygf.com/"><img src="/upload/jonllen/article/citygf.gif" /></a></p>
<p style="text-indent: 2em;">类　　型：门户网站</p>
<p style="text-indent: 2em;">开发时间：2009.03~2009.10</p>
<p style="text-indent: 2em;">参与人数：20人以上</p>
<p style="text-indent: 2em;">项目说明：这是一个大型的综合门户网站，前台页面使用CMS内容发布系统静态发布，程序是采购TRS的内容协作平台WCM，系统架构采用Linux+Java+Tomcat+Oracle，前期主要调用系统的接口置标包页面，我参与了旅游、佛山房产等栏目的包装。后期的通行证、博客、圈子、分类信息系统采用.Net+SQL2005开发，我主要负责后台、博客、圈子、分类信息模块，及后期的程序优化和论坛模板修改，验收阶段编写了模块开发卷宗、数据库设计说明书文档。</p>
<p style="text-indent: 2em;"><strong>二、美酒在线</strong></p>
<p style="text-indent: 2em;"><a target="_blank" href="http://www.m999.com"><img src="/upload/jonllen/article/m999.gif" /></a></p>
<p style="text-indent: 2em;">类　　型：商城</p>
<p style="text-indent: 2em;">开发时间：2009.08~2009.10</p>
<p style="text-indent: 2em;">参与人数：8人左右</p>
<p style="text-indent: 2em;">项目说明：这是一个非常典型的在线商城系统，整体来说不算很复杂，前台主要是分类X(交叉)商品X(交叉)品牌的一个结构显示，以及会员订单的一个处理。</p>
<p style="text-indent: 2em;"><strong>三、iKnow</strong></p>
<p style="text-indent: 2em;"><img width="183" src="/upload/jonllen/article/cover_633945329925781250_iKnow.gif" alt="iKnow" height="93" /></p>
<p style="text-indent: 2em;">类　　型：问答系统</p>
<p style="text-indent: 2em;">开发时间：2009.10.29~2009.11.25</p>
<p style="text-indent: 2em;">参与人数：3人</p>
<p style="text-indent: 2em;">项目说明：这是我全权负责的一个项目，包括前后台程序架构搭建、数据库设计、项目需求跟进等。网站实现的是类似百度知道的功能，用户能发表问题、设置最佳答案、举行投票、关闭问题等。</p>
<p style="text-indent: 2em;"><strong>四、建行金融卖场</strong></p>
<p style="text-indent: 2em;"><img src="/upload/jonllen/article/shopbanking.gif" /></p>
<p style="text-indent: 2em;">类　　型：商城</p>
<p style="text-indent: 2em;">开发时间：2009.10~2009.12</p>
<p style="text-indent: 2em;">参与人数：5人</p>
<p style="text-indent: 2em;">项目说明：这是建行的一个金融商城项目，展示的商品主要分为理财产品、在线缴费、实物商品三大类，不同分类商品的购买流程不一样，商品可以设置到不同地址的运费，第三方供应商品可以管理自己的商品，用户可以选择多个订单进行合并支付，支付使用建行的com接口和银联接口，是一个客户需求比较复杂的系统。</p>
</div>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2010-01-04 23:24</li>
				<li>update@ 2010-01-16 15:21:39</li>
				<li>阅读(<span id="articleClick">7945</span>)</li>
				<li>评论(0)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/work/96.aspx">今天回公司处理问题</a></li>
<li>下一篇：<a href="/jonllen/work/99.aspx">2009年工作总结及2010年工作计划</a></li></ul>
		</div>
...
<div class="correlative">
	...
	暂无任何评论。
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=98&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/work/98.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=98";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
