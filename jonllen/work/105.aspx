...
<head>
<title>杨总谈话 - 工作 - 金龙博客</title>
<meta name="description" content="今天下午5：30，我们技术部门的所有员工进行开会，杨总第一次和我们技术部的人员开部门会议，我们每个人都要进行一、二分钟的工作汇报总结发言，之后再是杨总的对我们总结发言。杨总谈话充满激情，但又不是空虚脱离现实，短短几个小故事，教会我们大家如何来成功。以前一直对一个公司的副总没有概念，今天杨总亲口跟我们说他以前是做职业经理的，年薪30万，而今又来到了时代财富，并投资做了公司股东，因为想亲手把时代财富带大成个一流的公司..." />
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2010-03-03' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/work/105.aspx">杨总谈话</a>
		</div>
        <div class="article">
			<div class="title"><h2>杨总谈话</h2></div>
...
<p style="text-indent: 2em;">今天下午5：30，我们技术部门的所有员工进行开会，杨总第一次和我们技术部的人员开部门会议，我们每个人都要进行一、二分钟的工作汇报总结发言，之后再是杨总的对我们总结发言。</p>
<p style="text-indent: 2em;">杨总谈话充满激情，但又不是空虚脱离现实，短短几个小故事，教会我们大家如何来成功。以前一直对一个公司的副总没有概念，今天杨总亲口跟我们说他以前是做职业经理的，年薪30万，而今又来到了时代财富，并投资做了公司股东，因为想亲手把时代财富带大成一个一流公司，成就一番的大事业，人生从此而没有遗憾！</p>
<p style="text-indent: 2em;">中兴通讯的行政财务的小姑娘告诉我们：企业团队的成长远远大于个人的成长，踏上一条优秀团队的船很重要；世界公认在一个行业全力以赴投入一万小时以上才能成功，雷军花了四万小时还没有成功，关键因素是时机；王老吉从一个亿的销售额跃升一百亿，背后是一点点在积累；明星企业家王石，有着&ldquo;于连那种不甘于平庸，以个人之力奋斗拼搏的野心&rdquo;，就像登珠穆朗玛峰，树立标杆很重要。</p>
<p style="text-indent: 2em;">一个个小故事告诉：要使自己过上高品质的生活，自己的努力是必不可少的，但还必须依附于一个有朝气、有目标的团队，个人必须树立标杆，并付诸行动。我不知道成功的具体标志是什么，不过至少现在还能脚塌实地的工作，在成长过程中积累点点滴滴。</p>
</div>
<script type="text/javascript" src="/scripts/popup.js"></script>
<div id="mod-popup" style="overflow: hidden; width: 200px; height: 114px; top: 500px; right: 0pt; display: none;"><a href="javascript:;" style="position: absolute; right: 2px; top: 4px;" id="mod-popup-close"><img title="关闭" src="http://www.by.gov.cn/model/htmltemplate/byqzf/images/mod-popup-close.png" border="0" /></a><a href="http://wspy.by.gov.cn/index.aspx" target="_blank"><img title="点击参加白云区网上评议" src="http://www.by.gov.cn/model/htmltemplate/byqzf/images/mod-popup.jpg" border="0" /></a></div>
<script type="text/javascript">// <![CDATA[
    window.onload =function (){
document.getElementById('mod-popup').style.display = 'block';
Popup.init({
 target : 'mod-popup',
 closeButton : 'mod-popup-close',
 autoOpen : true,
 autoLayout : true,
 listenEsc : false,
 align : 'right',
...
// ]]></script>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2010-03-03 21:34</li>
				<li>update@ 2010-03-17 09:40:18</li>
				<li>阅读(<span id="articleClick">7799</span>)</li>
				<li>评论(2)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/work/99.aspx">2009年工作总结及2010年工作计划</a></li>
<li>下一篇：<a href="/jonllen/work/111.aspx">天河部落网站升级改版工作</a></li></ul>
		</div>
...
<div class="correlative">
			...
			<div class="commentlist" id="commentContent">
				        ...
				        <div class="item">
					        <div class="desc">
						        ...
						        <a>1楼</a> 文夕 2010-03-05 23:11:21
					        </div><div class="cont">成功不容易啊！加油~</div>
					        <div class="reply" ><span>回复：</span>是啊~（2010-03-06 10:17:04）</div>
				        </div>
				        ...
				        <div class="item">
					        <div class="desc">
						        <ul class="options">
							        <li><a href="javascript:;" onclick="quote(this,'popo')">引用</a></li>

						        </ul>
						        <a>2楼</a> popo 2010-03-06 20:30:35
					        </div><div class="cont">你的模版，还圣诞快乐 （＃－－）</div>
					        <div class="reply" ><span>回复：</span>呵呵，有时间就换了，还没找到好的素材~（2010-03-07 17:10:57）</div>
				        </div>
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=105&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/work/105.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=105";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
