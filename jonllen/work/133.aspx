...
<head>
<title>项目中的A、B、C、D、E角色 - 工作 - 金龙博客</title>
<meta name="description" content="今天是12.27广州亚运会的闭幕，广州又度过了一场激情盛会，身在广州我能够感受得到这座城市的美好，为之无私奉献的亚运志愿而感动，为之在赛场拼搏的运动键儿而鼓舞。今晚，在璀璨的烟火中，结束了这场盛会，广州亚运注定将在脑海里留下另人难忘的记忆。
		        ...
		        Ajax.send({
		            ...
		            fn : function (data){
	                    ...
	                    if (rs.success)
	                    {
	                        ...
	                        WdatePicker( { eCont :'calendar', firstDayOfWeek :1, specialDates :archive.length > 0 ? archive : null, onpicked :ePicked, startDate:'2010-11-27' } );
 	                    }else
	                    {
	                        alert(rs.error);
	                    }
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/work/133.aspx">项目中的A、B、C、D、E角色</a>
		</div>
        <div class="article">
			<div class="title"><h2>项目中的A、B、C、D、E角色</h2></div>
			...
			<div class="cont" id="content">
				<p>今天是12月27日，是广州亚运会的闭幕，广州又度过了一场激情盛会，身在广州我能够感受得到这座城市的美好，为之无私奉献的亚运志愿而感动，为之在赛场拼搏的运动键儿而鼓舞。今晚，在璀璨的烟火中，结束了这场盛会，广州亚运注定将在脑海里留下另人难忘的记忆。</p>
<p>昨天本是亚运会闭幕要放假一天，后来公司临时出个紧急通知规定正常上班，年假再多放一天补回来，好多人都说计划泡汤了，不过我能理解，首先又不是不放，而且年底到了很多项目要收尾，拿我手头上的工作来说可能加班都做不完。</p>
<p>昨天下午张总给我们做培训，其实是做一个游戏，一个关于项目团队沟通协作的游戏，感觉很有意思的。我们被分成几个小组，每个小组中分别有A、B、C、D、E这几种角色的人，沟通规则如下图所示：</p>
<p><img src="/upload/jonllen/article/pm.gif" alt="项目管理" /></p>
<p>每种角色人的只能和箭头指向的人进行沟通，这好比是我们平时工作时的组织架构，A负责提出问题，然后交给B进行处理，B需要沟通协调C、D、E，然后做出正确的回答给A，就算完成任务。每个人的沟通的方式为使用写小纸条相互传递，每个人分别5张小纸条，第一次写小纸条的内容字数不受限制，收到人需要修改涂写在转发给别人则限制在10个字以内，如果超过只能重新用写小纸条，时间最快且使用的小纸条数最少的组获胜。</p>
<p>游戏就这样开始了，我被调到了B角色的位置上。每个人发一张&ldquo;试卷&rdquo;，里面有几个图行，问题是找下面图形中的相同的图形，除开A以外任何人不能将自己的图形告诉别人，否则就算违犯。但就这样一个简单的问题，很惊讶的是竟然只有一组能做出正确的回答，这真的值得我们每一个人反思。而我当时已得到了一些提示，但我还是没能抓住机会，还是没能明确目标，没能冷静下来，情急之下做了一个错误的答案，有负众望，没能做好沟通协调好整个团队，最终也没能完成任务。</p>
<p>虽然是个游戏，但里面的道理却很深，特别是每个角色如何做好自己的工作，这个意味深长，怪不得张总要召集公司所有来做这个游戏。</p>
<p><strong>A</strong></p>
<p>A角色一般是领导，有时候也可能是客户，是整个任务的下达者。相信在这个游戏中没有完成任务的，A的反响应该是最大，绝大部分的组之所以没能完成任务，很大一部分原因是归咎A下达的任务不够清晰明确，以为B会明白，如果B没能及时沟通清楚，很容易就模糊目标了，后面的C、D、E更是不知所然。相反，如果A能一次性的把问题描述清楚，那么任务传递到下面也能很快的进行解决。</p>
<p><strong>B</strong></p>
<p>B角色一般是项目经理，起到承上启下的作用，无疑是项目团队的核心。B在接到A的任务时，首先需要冷静的分析任务目标，如不清楚需要努力的再和A进行沟通，再将任务分配给C、D、E来完成。</p>
<p><strong>C</strong></p>
<p>C代表设计师，因为他是B给出需求后，完成项目的第一个流程。网页首先需要经过设计师界面设计，完成后再交回给B。</p>
<p><strong>D</strong></p>
<p>D为网站的前端制作，B要求他按C设计出的界面使用DIV+CSS制作出静态页面，经测试没问题后，再交回给B。</p>
<p><strong>E</strong></p>
<p>E代表程序员，是项目完成的最后一个流程。</p>
<p>从团队合作的角度来说，沟通确实是已成为完成一个项目的重要环节，沟通的好坏，将直接影响到项目的成败和质量。而作为项目经理，沟通是一门必不可少的技能之一。但有时候上级不是领导，而是客户，而客户自己本身对需求不清晰，这就需要自己进行主动的沟通。但又换一个角度来说，有些可能会选择等待，有时候目标不明确时，会瞎忙，造成资源成本浪费。</p>
<p>从项目组织机构的类型来说，上图描述的应为项目组织型，只不过C、D、E之间应该也能进行交流沟通。职能组织型则是按部门划分人员，有利于同部门之间职业交流，也是我们公司之前的项目组织机构的类型。另外一个矩阵组织型，也是我们公司目前的项目组织机构的类型，它是职能组织型和项目组织型的结合，加强了各职能部门同各项目之间的协作关系，是应用最广泛的新型组织形式。</p>
<p>从做人处世来说，要方圆处事。方是立足之本，要有规矩约束，即做人要正直善良；圆是通融，圆无角不伤人不易自伤，即做人处世要懂得技巧变通。只要是会抓老鼠的猫都是好猫，只要能完成任务，就算是成功。</p>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2010-11-27 23:20</li>
				<li>update@ 2010-11-28 02:06:08</li>
				<li>阅读(<span id="articleClick">8856</span>)</li>
				<li>评论(3)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/work/131.aspx">天河部落揪着我的心</a></li>
<li>下一篇：<a href="/jonllen/work/135.aspx">2010年度工作总结</a></li></ul>
		</div>
...
<div class="correlative">
			...
			<div class="commentlist" id="commentContent">
				        ...
				        <div class="item">
					        <div class="desc">
						        ...
						        <a>1楼</a> 文夕 2010-11-29 22:55:12
					        </div><div class="cont">不错，有个朋友也研究这方面的东东</div>
					        <div class="reply" ><span>回复：</span>呵呵，项目管理中的学问蛮多的。（2010-12-04 13:29:49）</div>
				        </div>
				        ...
				        <div class="item">
					        <div class="desc">
						        <ul class="options">
							        <li><a href="javascript:;" onclick="quote(this,'bronze casting')">引用</a></li>

						        </ul>
						        <a>2楼</a> bronze casting 2010-12-08 17:15:47
					        </div><div class="cont">这大概是一个项目的流程吧</div>
					        <div class="reply" ><span>回复：</span>是项目管理中的沟通~（2010-12-10 19:51:43）</div>
				        </div>
				        ...
				        <div class="item">
					        <div class="desc">
						        <ul class="options">
							        <li><a href="javascript:;" onclick="quote(this,'儿童玩具车')">引用</a></li>

						        </ul>
						        <a>3楼</a> 儿童玩具车 2010-12-15 16:28:18
					        </div><div class="cont">路过，支持</div>
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=133&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/work/133.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=133";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
