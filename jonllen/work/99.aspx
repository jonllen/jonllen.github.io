...
<head>
<title>2009年工作总结及2010年工作计划 - 工作 - 金龙博客</title>
<meta name="description" content="接上级通知，写2009年工作总结及2010年工作计划报告一份，内容如下：
    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/work/99.aspx">2009年工作总结及2010年工作计划</a>
		</div>
        <div class="article">
			<div class="title"><h2>2009年工作总结及2010年工作计划</h2></div>
...
<p style="text-indent: 2em;">接上级通知，写2009年工作总结及2010年工作计划报告一份，内容如下：</p>
<p style="text-indent: 2em;">从2009年3月份开始进公司，学习了很多，感悟过很多，认知到很多。在做<a href="/jonllen/aspnet/26.aspx" target="_blank" title="门户网站的形成&mdash;CMS内容管理系统">广佛项目</a>的时候，尤其是出差加班那段时间，我才真正体会到了什么是工作，那是一种责任。在<a href="/jonllen/breast/nianhui.aspx" target="_blank" title="时代财富9周年年庆">公司年庆</a>组织去厦门古浪屿旅游的时候，在海岛上看到天际交接的景象，内心掩盖不了欢腾的喜悦，特别是那个晚会，让人陶醉和回味。在做<a href="/jonllen/work/62.aspx" target="_blank" title="/jonllen/work/62.aspx">IBOX系统</a>开发的时候，我认识到了什么是效率，别人有的我们也能做出来，同时见证了公司产品化的一个过程。太多的太多，不胜枚举。</p>
<p style="text-indent: 2em;">做为一名技术人员的我，掌握的知识还远远不够，觉得自己还不太成熟，有时候会因为<a href="/jonllen/reflection/44.aspx" target="_blank" title="项目里面至关重要的东西&mdash;细节">粗心犯些小问题</a>，但这些问题应该能够避免的。有时候觉得有些东西这样做不妥，但自己却找不出一个更好的解决方案来。还有自己的解决分析问题能力不够，就像是去<a href="/jonllen/reflection/79.aspx" target="_blank" title="审计署，这次让我感觉那么的无能为力。">审计署</a>的那次，明明是一个比较简单的问题，我却因为被一些表面现象所迷惑而很久才发现问题的根源所在。我公司作为一个网络技术型公司，要提高产品和项目的质量，我觉得还得要从我们每一个技术人员抓起，因为技术人员每写的一行代码是直接反映在了产品的某一功能上，如果我们每个人进步一点点，那公司就向前跨出了一大步。我觉得对技术人员实施奖罚分明是一个很好的措施，奖，它能鼓起大家的积极性，罚，也能压制更多错误的产生。</p>
<p style="text-indent: 2em;">在新的一年的，我对自己提出以下几点目标。第一，严格自律，写出更加优质的代码。不管在那个项目，不管别人写的怎么样，先要保证自己写的是尽善其美，如果发现他人写的有问题，可先与之讨论，并确认问题后提出更好的解决方法。第二，提升问题的分析能力。对于一些需求，或是连项目经理都不知道要怎么做的，自己应该能拿出一些合理的建议，准确的判断出客户所需要的功能。第三，提高工作效率和学习能力。工作是一个学习的过程，学习能力也能反映出工作的效率，对于IT技术行业来说，只有每天不断的积累和学习才不至于会被淘汰。抓紧有利的学习时机，不断充实自己，掌握各方面的技能，以提升工作效率。</p>
<p style="text-indent: 2em;">报告完毕！Over~</p>
</div>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2010-01-05 21:11</li>
				<li>update@ 2010-01-05 23:11:47</li>
				<li>阅读(<span id="articleClick">7711</span>)</li>
				<li>评论(1)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/work/98.aspx">总结今年的几个项目案例</a></li>
<li>下一篇：<a href="/jonllen/work/105.aspx">杨总谈话</a></li></ul>
		</div>
...
<div class="correlative">
		...
		<div class="comment">
			...
			<div class="commentlist" id="commentContent">
				        ...
				        <div class="item">
					        <div class="desc">
						        <ul class="options">
							        <li><a href="javascript:;" onclick="quote(this,'Brian')">引用</a></li>

						        </ul>
						        <a>1楼</a> Brian 2010-01-17 00:57:30
					        </div><div class="cont">总结太简单了吧.</div>
					        <div class="reply" ><span>回复：</span>哈哈，那要怎么写？贴下你的咯~`（2010-01-17 18:07:03）</div>
				        </div>
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=99&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/work/99.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=99";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
