    ...
    <div class="articlecont">
        <div class="position">
		    ...
		    <a href="http://www.jonllen.com">首页</a>
		     ...
		     > <a href="/jonllen/work/96.aspx">今天回公司处理问题</a>
		</div>
        <div class="article">
			<div class="title"><h2>今天回公司处理问题</h2></div>
...
<p style="text-indent: 2em;">好不容易元旦连放三天假，今天下午接到电话叫我回公司处理建行金融卖场的问题，还要先打的士跑到岗顶去同事那里拿钥匙，然后再打的回公司解决系统问题，55555~</p>
<p style="text-indent: 2em;">事情是这样的， 我年轻的时候参与做过一个建行金融卖场的项目，但这周一我就被从这个项目中抽出来了，准备做一些Java相关的开发，本以为彻底解脱了，没想到客户一个电话，我就得要乖乖的回公司去解决系统的问题。不过这也怨不得谁了，谁叫我住公司近元旦又没有约呢！还好今天回到公司，排查了一下原因发现不是程序问题，而是客户那边建行商户后台把页面通知和服务器通知地址设置反了，导致网银支付成功之后不能正确的返回支付成功页面，所有的支付成功的订单状态还是未付款，后来把这两天支付有问题的订单支付的流水号记录调出来，还好记录不是很多只有35条，客户拿回去再和建行商户后台导出来的支付流水记录对照，进后台一条条把支付过的订单改为已支付，问题解决，5点不到就回来了。</p>
<p style="text-indent: 2em;">话说这个建行金融卖场的项目，我还得真要记一帐。系统不算是很大，属于B2C类型的商城，但是却有他们内部的一些特殊需求，比如他们员工可以实现在线缴团费和党费，并且团费和党费作为一个商品存在，商品的不同扩展字段对应不同员工的工号，每下一个团、党费的订单该商品自动下架。诸如此类，造成这个系统里面有太多的一些"特殊"判断处理，看的代码都会感觉很臃肿。曾几何时，为了建行金融卖场这个项目而加班也搞得混天黑地，尽而酿成了回来在楼顶星空之夜收被子的杯具。。。</p>
<p style="text-indent: 2em;">今日要早睡，明日要早起看《系统集成项目管理工程师教程》，准备今年5月份的国家软考。哎，元旦一起三天假看着一晃就没了，抓不住的时间在流逝~</p>
</div>
			</div>
			...
			<div class="desc">
			  <ul>
				<li>posted@ 2010-01-02 18:13</li>
				<li>update@ 2010-01-02 20:56:21</li>
				<li>阅读(<span id="articleClick">7163</span>)</li>
				<li>评论(1)</li>
...
<div class="context">
			<ul>
				<li>上一篇：<a href="/jonllen/work/94.aspx">linux下常用管理命令</a></li>
<li>下一篇：<a href="/jonllen/work/98.aspx">总结今年的几个项目案例</a></li></ul>
		</div>
...
<div class="correlative">
		...
		<div class="comment">
			...
			<div class="commentlist" id="commentContent">
				        ...
				        <div class="item">
					        <div class="desc">
						        <ul class="options">
							        <li><a href="javascript:;" onclick="quote(this,'aify')">引用</a></li>

						        </ul>
						        <a>1楼</a> aify 2010-01-05 08:07:01
					        </div><div class="cont">怎么不能写网址呀，不会是cms的吧，不过加班是正常的！现在的社会都是这样</div>
					        <div class="reply" ><span>回复：</span>(╯﹏╰)这个网址字段我找时间就加上。（2010-01-05 09:24:21）</div>
				        </div>
        ...
        <script type="text/javascript">
		    ...
		    {
		        var url = "/plugin/web/doSaveComment.do?sourcetype=1&sourceid=96&siteId=1";
		        var data = "username="+encodeURIComponent(document.getElementById("txtUserName").value);
		        data += '&sourceurl=/jonllen/work/96.aspx';
...
document.getElementById('commentContent').appendChild(itemComment);
            ...
            function addClick()
		    {
		        var url = "/plugin/web/doAddClick.do?columnType=1&documentId=96";
		        Ajax.send({
		            type : "GET",
		            url : url,
		            fn : function (data){
