...
<script type='text/javascript'>function goToPage0(pid, urlformat){var url = "/pengfenjun/xinqingyulu/index__pid.aspx";if(urlformat)url=urlformat;document.location.replace(url.replace("_pid",pid).replace("_1.","."));}</script>
	</div>
