...
四、延迟加载
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2011-03-26 23:19:11</li>
				            <li>阅读(9784)</li>
...
4）myeclipse-8.6
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2011-02-26 11:32:38</li>
				            <li>阅读(10803)</li>
...
开心工作，快乐生活...
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2011-02-18 21:01:15</li>
				            <li>阅读(8131)</li>
...
5.醉了
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2011-01-21 23:09:15</li>
				            <li>阅读(9604)</li>
...
今天这篇文章实在是有感而发，一个是我的好朋友，一个是我认为很认真的一个人，实在是有点舍不得。今天不写我怕以后会把你们给忘记了，祝福你们，希望你们早日得到自己想要的一切！
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2011-01-18 23:41:42</li>
				            <li>阅读(8224)</li>
...
7.僵局
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2011-01-15 23:42:56</li>
				            <li>阅读(8330)</li>
...
通过2010年的洗礼，相信我又坚强了很多，成长了很多。但在接下来的2011年里，我仍不能松懈，必须持之以恒的坚持下去。2010，我想说我今年并没有白干；2011，我期望新的一年里会更精彩。
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2011-01-01 22:47:43</li>
				            <li>阅读(8949)</li>
...
6.发布网站
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-12-26 12:22:54</li>
				            <li>阅读(8690)</li>
...
昨天下午张总给我们做培训，其实是做一个游戏，一个关于项目团队沟通协作的游戏，蛮有意思的。我们分成几个小组，每个小组中分别有A、B、C、D、E这几中角色的人，他们的沟通规则如图所示。
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-11-27 23:20:06</li>
				            <li>阅读(9800)</li>
...
从到天河公园溜冰摔倒贴了2周膏药，到项目出现很多问题，再到前段时间看烟花脚趾被石头绊伤，好象都是杯具上演。不知道后面还有没有完，希望不要再来了。
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-11-21 12:52:45</li>
				            <li>阅读(7005)</li>
...
3.测试
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-10-31 22:17:56</li>
				            <li>阅读(8133)</li>
...
<li>6.结束语</li>
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-10-17 12:33:46</li>
				            <li>阅读(8489)</li>
...
今天是2010-10-10，很值得纪念的一天，希望也能成为我真正长大跨越的一天。改变未来，从当前开始，从足下行动！
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-10-10 10:10:10</li>
				            <li>阅读(6979)</li>
...
再过一个星期就国庆可以回家了，每次回家前都是归心似箭，可一回到家了呢，又没有想象中的那么喜悦，感觉也仅仅是如此。在离开前的最后一个晚上，然而又被感珍惜，每一年都是如此轮回。
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-09-23 18:07:08</li>
				            <li>阅读(6987)</li>
...
6.小结
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-08-08 12:37:01</li>
				            <li>阅读(10157)</li>
...
4.锻炼
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-08-01 17:53:24</li>
				            <li>阅读(11563)</li>
...
基于ADO.Net，各种主流数据库的访问得以支持实现，Access可使用OleDb，SQL Server使用SqlClient，Oracle使用OracleClient，而MySql使用MySql.Data开源库，且ADO框架提供了良好的接口，如要提供对其他数据库的支持只需实现ADO接口。当然，在我的ORM里为了更好的封装，我也定义了一些接口...
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-07-06 22:27:02</li>
				            <li>阅读(9867)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-07-01 23:36:21</li>
				            <li>阅读(10189)</li>
...
<div class="item">
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-06-27 17:32:42</li>
				            <li>阅读(7938)</li>
...
四、结束语
			            ...
			            <div class="desc">
			              <ul>
				            <li title="">posted@ 2010-07-01 00:05:02</li>
				            <li>阅读(9319)</li>
...
<script type='text/javascript'>function goToPage0(pid, urlformat){var url = "index__pid.aspx";if(urlformat)url=urlformat;document.location.replace(url.replace("_pid",pid).replace("_1.","."));}</script>
                            ...
                            <!--每页<input type='text' value='20' id='_pagersize0' style='width:25px'>条,转到第<input type='text' value='3' id='_pagerid0' style='width:25px'>页<input type='button' value='Go' onclick='javascript:goToPage0(document.getElementById("_pagerid0").value,"index__pid.aspx".replace("psize=20","psize=" + document.getElementById("_pagersize0").value));'>-->
